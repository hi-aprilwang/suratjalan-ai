...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'rounded-xl border border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-950/70 text-zinc-900 dark:text-zinc-100 shadow-sm backdrop-blur-sm transition-colors',
        className
      )}
      {...props}
    />
