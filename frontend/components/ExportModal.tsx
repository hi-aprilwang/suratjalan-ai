    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent onClose={onClose} className="max-w-2xl bg-zinc-950 border-zinc-800 p-0 overflow-hidden">
        ...
        <div className="p-5 space-y-4 max-h-[75vh] overflow-y-auto">
          ...
          <div>
            <div className="text-sm uppercase tracking-wider text-zinc-400 mb-2 font-semibold">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              {erpOptions.map((sys) => (
                ...
                >
                  <span className="font-bold text-sm block text-zinc-100">{sys.name}</span>
          ...
          {/* Sync Result Banner */}
          {syncedResult && (
            <div className="bg-emerald-950/60 border border-emerald-800/80 rounded-lg p-3 flex items-center gap-2.5 text-emerald-300 text-sm font-semibold">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                size="sm"
                onClick={handleCopy}
                className="h-7 text-sm font-medium gap-1.5 border-zinc-800 text-zinc-300"
              >
            ...
            <div className="rounded-lg border border-zinc-800 bg-zinc-900/90 overflow-hidden text-sm">
              <pre className="p-3.5 text-zinc-300 max-h-60 overflow-y-auto leading-relaxed">
                {payloadString}
              </pre>
            </div>
          </div>
        ...
        {/* Footer Actions */}
        <div className="px-5 py-3.5 border-t border-zinc-800 bg-zinc-900/60 flex items-center justify-between gap-3">
          <Button
            variant="outline"
            size="sm"
